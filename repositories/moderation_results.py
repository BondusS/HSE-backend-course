...
class ModerationResultRepository:
    ...
    async def update_result(
        ...
        # Обновляем индексы параметров, если is_violation или probability не были переданы
        # Это упрощенный подход, в реальном проекте лучше использовать sqlalchemy.text
        # или более сложную логику для динамического построения запроса.
        final_set_clauses = []
        param_idx = 2
        ...
        # Пересобираем параметры, исключая None
